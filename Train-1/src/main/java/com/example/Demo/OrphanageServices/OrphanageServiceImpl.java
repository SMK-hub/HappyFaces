...
public class OrphanageServiceImpl implements OrphanageService {
	...
	public String registerUser(Orphanage newUser) {
		...
		if (!user.isPresent()) {
			...
			String body="Dear "+newUser.getName()+", thank you for registering with Happy Faces! Your commitment to our cause brings hope and happiness to the lives of many. Welcome to our compassionate community!";
